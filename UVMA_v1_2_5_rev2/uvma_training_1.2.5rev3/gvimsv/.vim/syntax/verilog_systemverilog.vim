...
syn keyword uvmMethod            accept_tr apply_config_settings begin_child_tr begin_tr build_phase check_phase clone final_phase
syn keyword uvmMethod            connect_phase create create_component create_object do_accept_tr do_begin_tr do_end_tr
syn keyword uvmMethod            do_flush do_func_phase do_kill_all do_resolve_bindings do_task_phase end_of_elaboration_phase
syn keyword uvmMethod            end_tr extract_phase flush get_child get_config_int get_config_object get_config_string
...
syn keyword uvmMethod            record_event_tr report_phase resolve_bindings restart resume run_phase set_config_int set_config_object
...
syn keyword uvmMethod            start_of_simulation_phase status stop suspend
syn keyword uvmMethod            pre_reset_phase reset_phase post_reset_phase pre_configure_phase configure_phase post_configure_phase 
syn keyword uvmMethod            pre_main_phase main_phase post_main_phase pre_shutdown_phase shutdown_phase post_shutdown_phase
...
" uvm_sv/src/base/uvm_phase.sv
syn keyword uvmClass             uvm_phase
syn keyword uvmMethod            get_objection raise_objection drop_objection
...
syn keyword uvmDeprecatedMethod  check_min_connection_size check lookup_indexed_if
...
syn keyword uvmMethod            initialize report_phase report_header run_hooks set_default_file set_defaults
...
syn keyword uvmMethod            insert_phase run_global_phase run_test stop_request print_topology 
syn keyword uvmDeprecatedClass   uvm_test_top
syn keyword uvmDeprecatedMethod  print_unit print_unit_list print_units
...
syn keyword uvmMethod            connect flush get_type_name run_phase
...
syn keyword uvmMethod            build_phase check_port_connections end_of_elaboration_phase
...
syn keyword uvmMethod            end_of_elaboration_phase get_next_item run_phase set_scenario_controller
...
syn keyword uvmMethod            get_type_name connect_phase build_phase end_of_elaboration_phase send_request get_next_item try_next_item item_done put get peek
...
syn keyword uvmMethod            do_print connect_phase build_phase send_request get_current_item put_response analysis_write start_default_sequence run_phase
...
syn keyword uvmMethod            create create_aliased_exports connect_phase get_type_name
